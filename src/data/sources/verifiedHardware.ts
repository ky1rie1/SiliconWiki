...
const verifiedHardwareFacts: Record<string, HardwareVerification> = {
  'cpu-amd-9800x3d': {
    ...
    fields: {
      ...
      '基础功耗 / 最大睿频功耗': { fieldId: 'cpu.defaultTdp', value: '120W 默认 TDP（非实测功耗）', sourceField: 'Default TDP', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
  ...
  'cpu-amd-9950x': {
    ...
    fields: {
      ...
      '基础功耗 / 最大睿频功耗': { fieldId: 'cpu.defaultTdp', value: '170W 默认 TDP（非实测功耗）', sourceField: 'Default TDP', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
      '插槽接口': { fieldId: 'cpu.socket', value: 'AM5', sourceField: 'CPU Socket', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
      '内存支持': { fieldId: 'memory.support', value: 'DDR5-5600（2×1R / 2×2R）；DDR5-3600（4×1R / 4×2R）', sourceField: 'Max Memory Speed', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
      '制程工艺': { fieldId: 'cpu.process', value: 'CPU 核心 TSMC 4nm FinFET；I/O Die TSMC 6nm FinFET', sourceField: 'Processor Technology for CPU Cores / Processor Technology for I/O Die', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
    },
  ...
  'gpu-nvidia-rtx5090': {
    ...
    fields: {
      ...
      '整卡功耗 (TGP/TBP)': { fieldId: 'gpu.tgp', value: '575W TGP（参考设计）', sourceField: 'Total Graphics Power (W)', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
  ...
  'gpu-nvidia-rtx5080': {
    ...
    fields: {
      ...
      '整卡功耗 (TGP/TBP)': { fieldId: 'gpu.tgp', value: '360W TGP（参考设计）', sourceField: 'Total Graphics Power (W)', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
      'Tensor 核心': { fieldId: 'gpu.tensorGeneration', value: '第 5 代', sourceField: 'Tensor Cores (AI)', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
    },
    tdpWatts: 360,
    powerSourceField: 'Total Graphics Power (W)',
  ...
  'gpu-nvidia-rtx4070super': {
    ...
    fields: {
      ...
      '整卡功耗 (TGP/TBP)': { fieldId: 'gpu.tgp', value: '220W', sourceField: 'Total Graphics Power (W)', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
    },
    tdpWatts: 220,
    powerSourceField: 'Total Graphics Power (W)',
  },
  'gpu-colorful-rtx4070s-ultra-w': {
    ...
    checkedAt: '2026-09-11',
    scope: '已核验七彩虹非公版物理尺寸、超频频率、供电接口及标称功耗。',
    ...
    fields: {
      ...
      '整卡功耗 (TGP/TBP)': { fieldId: 'gpu.tgp', value: '220W (一键超频 245W)', sourceField: 'TGP', sourceKind: 'manufacturer', verificationStatus: 'verified', checkedAt: '2026-09-11' },
