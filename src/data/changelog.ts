...
export const changelogList: ChangelogItem[] = [
  {
    version: 'v2.5.0',
    date: '2026-09-11',
    title: '3D装机性能重构与网格合批、工程设计体系刷新、硬件数据规范化与权威信源核验',
    tag: '最新发布',
    updates: [
      {
        type: 'perf',
        text: '3D 装机实验室渲染性能重构：引入同材质静态网格自动合批，稳态 Draw Call 直降 63.6%（475→173），且 100% 完整保留 7.6 万三角面几何细节。',
      },
      {
        type: 'feature',
      ...
      {
        type: 'perf',
        text: '分级渲染预算与后台休眠：支持省电/均衡/精细画质档位，依据画布尺寸与 DPR 动态约束渲染像素总量，场景离开视口或后台静默时暂停绘制。',
      },
      {
        type: 'feature',
        text: '瑞士工程图纸级设计系统刷新：告别模板化蓝紫配色，统一纸质暖白、矿物石墨黑与芯片暖金视觉基调；规范化 PageHeader 与 WikiIntro 架构，优化全端响应式与键盘焦点。',
      },
      {
        type: 'fix',
        text: '响应式文本覆写状态机修复：引入源文本与渲染文本双重状态调和解析，彻底根除多语言切换被旧 DOM 缓存覆写的时序冲突。',
      },
      {
        type: 'data',
      ...
      {
        type: 'feature',
        text: '全品类轻量化微架构矢量展台：重构 9 大硬件品类 SVG 工业蓝图插画，精准展现封装外形、PCB 走线与风扇叶片，附带真实产品图安全回退机制。',
      },
    ],
  },
  {
